...
class Attempt(db.Model):
    ...
    submitted_force_mag: Mapped[float] = mapped_column(db.Float, nullable=False)
    submitted_force_dir: Mapped[str] = mapped_column(db.String(16), nullable=False)
    correct_force_mag: Mapped[float] = mapped_column(db.Float, nullable=False)
    correct_force_dir: Mapped[str] = mapped_column(db.String(16), nullable=False)
    force_mag_correct: Mapped[bool] = mapped_column(db.Boolean, nullable=False)
    force_dir_correct: Mapped[bool] = mapped_column(db.Boolean, nullable=False)
